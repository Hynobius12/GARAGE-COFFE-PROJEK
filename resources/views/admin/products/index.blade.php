<x-admin-layout>
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('admin.products.create') }}" class="bg-primary hover:bg-gray-800 text-white font-medium py-2 px-4 rounded transition">
            + Tambah Produk
        </a>
    </div>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                <div class="text-sm font-medium text-gray-900">
                                    {{ $product->name }}
                                    @if($product->is_featured) <span class="ml-1 text-xs bg-yellow-100 text-yellow-800 px-1 rounded">Bintang</span> @endif
                                </div>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                        <a href="{{ route('admin.products.variants.index', $product) }}" class="text-orange-600 hover:text-orange-900">Varian</a>
                        <a href="{{ route('admin.products.recipes.index', $product) }}" class="text-green-600 hover:text-green-900">Resep</a>
